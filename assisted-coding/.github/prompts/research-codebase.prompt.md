...
3. **Spawn parallel sub-agent tasks for comprehensive research:**
   ...
   **IMPORTANT**: All agents are documentarians, not critics. They will describe what exists without suggesting improvements or identifying issues.
    ...
    **For Architecture and Doc directory:**
   - Use the **doc-locator** agent (`.github/agents/doc-locator.agent.md`) to discover what documents exist about the topic
   - Use the **doc-analyzer** agent (`.github/agents/doc-analyzer.agent.md`) to extract key insights from specific documents (only the most relevant ones)
